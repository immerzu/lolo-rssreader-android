...
```powershell
adb logcat -d > F:\001_Coding_Projekte\RSS_Reader_Android\Ausgabe_APK\rss-reader-crash-log.txt
```

Die Datei liegt dann hier:

[rss-reader-crash-log.txt](F:\001_Coding_Projekte\RSS_Reader_Android\Ausgabe_APK\rss-reader-crash-log.txt)
...
4. `adb logcat -d > F:\001_Coding_Projekte\RSS_Reader_Android\Ausgabe_APK\rss-reader-crash-log.txt`
